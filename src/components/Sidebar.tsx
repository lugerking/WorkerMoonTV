...
const Logo = () => {
  ...
  return (
    ...
    >
      <span className='text-2xl font-extrabold tracking-tight brand-mark'>
        {siteName}
      </span>
    </Link>
  );
  ...
  return (
    <SidebarContext.Provider value={contextValue}>
      ...
      <div className='hidden md:flex'>
        <aside
          data-sidebar
          className={`fixed top-0 left-0 h-screen glass border-r border-black/5 transition-all duration-300 z-10 dark:border-white/10 ${
          ...
          <div className='flex h-full flex-col'>
            ...
            <div className='relative h-16'>
              ...
              <button
                ...
                className={`absolute top-1/2 -translate-y-1/2 flex items-center justify-center w-8 h-8 rounded-lg text-gray-500 transition-colors duration-200 z-10 hover:bg-black/[0.04] hover:text-emerald-600 dark:text-gray-400 dark:hover:bg-white/10 dark:hover:text-emerald-400 ${
